...
function adlerIndependentCase(input, expected) {
    const adler = new Adler32(),
          encoded = Util.encodeString(input);
...
describe("CRC32", () => {
    ...
    test("Checksum update", () => {
        ...
        crc.calculate(Util.encodeString("amogus"));
        expect(crc.value).toStrictEqual(0xa6515965);
    
        crc.calculate(Util.encodeString("morbius"));
...
describe("Adler32", () => {
    ...
    test("Checksum update", () => {
        ...
        adler.calculate(Util.encodeString("amogus"));
        expect(adler.value).toStrictEqual(0x08bb028d);
        
        adler.calculate(Util.encodeString("morbius"));
